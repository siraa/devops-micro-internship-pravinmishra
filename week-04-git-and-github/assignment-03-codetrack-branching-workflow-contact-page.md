...
![alt text](screenshots\sc1-T1-ass3-week4.png)
...
![alt text](screenshots\sc2-T1-ass3-week4.png)

![alt text](screenshots\sc2.1-T1-ass3-week4.png)
---
...
![alt text](screenshots\sc3-T3-ass3-week4.png)
...
![alt text](screenshots\sc5-T3-ass3-week4.png)
...
![alt text](screenshots\sc6-T4-ass3-week4.png)

---

#### Screenshot 7 — Output of `git commit`

![alt text](screenshots\sc7-T4-ass3-week4.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![alt text](screenshots\sc8-T4-ass3-week4.png)
...
![alt text](screenshots\sc14-T7-ass3-week4.png)
...
![alt text](screenshots\sc15-T8-ass3-week4.png)

...
![alt text](screenshots\sc6-T3-ass4-week6.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![alt text](screenshots\sc7-T3-ass4-week6.png)
...
![alt text](screenshots\sc8-T4-ass4-week6.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![alt text](screenshots\sc9-T4-ass4-week6.png)

---

#### Screenshot 10 — Output of `mysql --version`

![alt text](screenshots\sc10-T4-ass4-week6.png)
...
![alt text](screenshots\sc11-T5-ass4-week6.png)
...
![alt text](screenshots\sc13.1-T6-ass4-week6.png)
...
![alt text](screenshots\sc17-T8-ass4-week6.png)
